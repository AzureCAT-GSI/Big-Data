...
5. Click on the Diagram button to bring up the ADF diagram view, then zoom out and describe the overall layout of activities, pipelines and data sources like Blob Storage / SQL Database.                                                                                                                     <img src="./media/image15.png" width="87" height="43" />
